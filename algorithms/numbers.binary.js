...
/*The XOR operation (or exclusive or) takes two bits and returns 111 if exactly one of the bits is 111. 
Otherwise, it returns 000. 
...
findUniqueNumber([4,6,4,6,5,8,9,7,7,8,9])